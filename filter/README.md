...
![red smile](https://cs50.harvard.edu/x/2021/psets/4/filter/less/red_smile.png)
...
<iframe allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" class="border embed-responsive-item" data-video="" src="https://www.youtube.com/embed/K0v9byp9jd0?modestbranding=0&amp;rel=0&amp;showinfo=1&amp;list=PLhQjrBD2T3837jmUt0ep7Tpmnxdv9NVut" scrolling="no" id="iFrameResizer0" style="box-sizing: border-box; word-break: break-word; border: 1px solid rgb(222, 226, 230) !important; display: block; height: 480px; margin-bottom: 0px; min-width: 100%; width: 1px; background-color: rgb(0, 0, 0); overflow: hidden;"></iframe>
...
$ ./filter -u infile.bmp outfile.bmp
```
...
```
check50 csbaxter/problems/2021/x/filter/less
```
...
```
submit50 csbaxter/problems/2021/x/filter/less
```
